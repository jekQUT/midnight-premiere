...
public class pickupFatStacks : MonoBehaviour
{
    ...
    void Update()
    {
        if (interactable == true)
        {
            ...
            {
                //coinsCollected = coinsCollected + 9000;
                collectionSystem.amountCollected = collectionSystem.amountCollected + 9000; // from collectCoin.cs
